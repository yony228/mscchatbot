package cn.edu.nudt.pdl.yony.servicedunner.listerner;
...
//        private NioVisitorServer nioVisitorServer;
        ...
        @Value("#{T(cn.edu.nudt.pdl.yony.servicedunner.listerner.MessageListener.ServerType).valueOf('${self.server.type}'.toUpperCase())}")
